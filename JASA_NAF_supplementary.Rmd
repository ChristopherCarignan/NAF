...
```{r, echo=F}
setwd('/home/chris/Documents/research/JASA_acoustic_nasality')
```
...
dat1 <- cbind(testing[,c('type','vowel','timepoint','nasalance')],'nasalance')
dat2 <- cbind(testing[,c('type','vowel','timepoint','NAF')],'NAF')
dat3 <- cbind(testing[,c('type','vowel','timepoint','a1p0_compensated')],'A1P0')

# rename columns
colnames(dat1) <- c('type','vowel','timepoint','value','method')
colnames(dat2) <- c('type','vowel','timepoint','value','method')
colnames(dat3) <- c('type','vowel','timepoint','value','method')
